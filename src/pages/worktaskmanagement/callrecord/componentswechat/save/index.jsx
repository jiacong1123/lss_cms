...
class ComSave extends React.Component {
    ...
    render() {
        const { currentOrder,clinicdropmenu, jobordersource,reservedpro,electriclist,jobtitle,token, times} = this.props
                    ...
                    <Col span={12}>
                        <Form.Item label='性别' {...formItemLayout}>
                            {getFieldDecorator('sex', {
                                initialValue: user && user.sex ? user.sex : 1
                            })(
                                <RadioGroup>
                    ...
                    <Col span={12}>
                         <Form.Item label='跟进人员' {...formItemLayout}>
                            {getFieldDecorator('adminid', {
                                ...
                                initialValue: currentOrder && currentOrder.adminid ? currentOrder.adminid : ''
                            })(
                                <Select
                                    showSearch
                                    placeholder="请选择跟进人员"
