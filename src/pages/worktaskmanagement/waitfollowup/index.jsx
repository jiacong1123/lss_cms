...
const namespace = 'waitfollowup'

@connect(({layout,waitfollowup,worktaskmanagement}) => ({
  ...worktaskmanagement,
  ...layout,
  ...waitfollowup,
}),dispatch=>({
  ...
  onChangeLabels(payload) {
    ...
    //更新回访状态
    updateIsReturn(payload) {
      dispatch(
        _mmAction(
          `worktaskmanagement/EFFECTS_UPDATE_ISRETURN`,
          payload
        )
      )
    }
...
class Waitfollowup extends React.Component {
  ...
  render() {
    ...
    return (
      <div className={styles.waitfollowupPage}>
         <Filter {...this.props}/>
