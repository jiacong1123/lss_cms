...
const namespace = 'waitdistribution'
let userLabes = []
let lablenames = ""

@connect(({layout,waitdistribution}) => ({
  ...layout,
  ...waitdistribution,
}),(dispatch)=>({
...
class Waitdistribution extends React.Component {
  ...
  render() {
    ...
    return (
      <div className={styles.waitdistributionPage}>
        <Filter {...this.props}/>
