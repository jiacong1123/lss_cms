...
import {  Form, Row, Col, Input, Select, Radio, Cascader, DatePicker ,message, Upload, Icon, Checkbox } from 'antd';
        ...
        return (
            ...
            >
                <Row gutter={24}>
                    ...
                    <Col span={12}>
                    <Form.Item label='标签分类' {...formItemLayout}>
                        {getFieldDecorator('lables', {
                            ...
                            initialValue: currentNews && currentNews.lables ? currentNews.lables : ""
                        })(
                            <CheckboxGroup onChange={this.onChangeLables}>
                              <Checkbox value="隐适美">隐适美</Checkbox>
                              <Checkbox value="矫正">矫正</Checkbox>
                              <Checkbox value="种植">种植</Checkbox>
                              <Checkbox value="贴面">贴面</Checkbox>
                            </CheckboxGroup>
                        )}
                    </Form.Item>
                    </Col>
                    ...
                    <Col span={24}>
                        <Form.Item label='大图' {...formItemLayout}>
                    ...
                    <Col span={24}>
                        <Form.Item label='小图' {...formItemLayout}>
                    ...
                    <Col span={24}>
                        <Form.Item label='百科链接' {...formItemLayout}>
                            {getFieldDecorator('url', {
                                initialValue: currentNews && currentNews.url ? currentNews.url : ""
                            })(
                                <Input placeholder="请输入百科链接"/>
                            )}
                        </Form.Item>
                    </Col>
                    <Col span={24}>
                        <Form.Item label='百科内容' {...formItemLayout}>
